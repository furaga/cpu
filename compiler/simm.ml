...
*)
  | IfEq(x, C(y), e1, e2) -> print_endline "\tifeq"; IfEq(x, C y, g env e1, g env e2)
  | IfLE(x, C(y), e1, e2) -> print_endline "\tifle"; IfLE(x, C y, g env e1, g env e2)
  | IfGE(x, C(y), e1, e2) -> print_endline "\tifge"; IfGE(x, C y, g env e1, g env e2)
