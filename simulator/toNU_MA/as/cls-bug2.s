...
div_binary_search.334:
	...
	mul	%g8, %g7, %g4
	sub	%g9, %g6, %g5
	jlt	%g28, %g9, jle_else.739
	mov	%g3, %g5
	return
jle_else.739:
	jlt	%g8, %g3, jle_else.740
	jne	%g8, %g3, jeq_else.741
	mov	%g3, %g7
	return
jeq_else.741:
	mov	%g6, %g7
...
jle_cont.746:
	...
	sub	%g4, %g5, %g4
	sti	%g4, %g1, 20
	jlt	%g0, %g3, jle_else.749
	ldi	%g5, %g1, 16
	jne	%g5, %g0, jeq_else.751
	addi	%g3, %g0, 0
	jmp	jeq_cont.752
jeq_else.751:
	addi	%g5, %g0, 48
...
jle_cont.750:
	...
	sub	%g4, %g5, %g4
	sti	%g4, %g1, 28
	jlt	%g0, %g3, jle_else.753
	ldi	%g5, %g1, 24
	jne	%g5, %g0, jeq_else.755
	addi	%g3, %g0, 0
	jmp	jeq_cont.756
jeq_else.755:
	addi	%g5, %g0, 48
