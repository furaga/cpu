...
div_binary_search.351:
	...
	mul	%g9, %g4, %g7
	sub	%g3, %g6, %g5
	jlt	%g28, %g3, jle_else.746
	mov	%g3, %g5
	return
jle_else.746:
	jlt	%g9, %g8, jle_else.747
	jne	%g9, %g8, jeq_else.748
	mov	%g3, %g4
	return
jeq_else.748:
	mov	%g6, %g4
