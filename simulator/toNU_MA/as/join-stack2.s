...
jle_else.1714:
	jmp	div_binary_search.334
print_int.339:
	jlt	%g3, %g0, jge_else.1716
	mvhi	%g10, 1525
	mvlo	%g10, 57600
	jlt	%g10, %g3, jle_else.1717
	jne	%g10, %g3, jeq_else.1719
	addi	%g10, %g0, 1
	jmp	jeq_cont.1720
jeq_else.1719:
	addi	%g10, %g0, 0
...
jle_else.1717:
	mvhi	%g10, 3051
	mvlo	%g10, 49664
	jlt	%g10, %g3, jle_else.1721
	jne	%g10, %g3, jeq_else.1723
	addi	%g10, %g0, 2
	jmp	jeq_cont.1724
jeq_else.1723:
	addi	%g10, %g0, 1
...
jle_cont.1726:
	...
	ld	%g12, %g1, 0
	st	%g3, %g1, 4
	jlt	%g11, %g12, jle_else.1727
	jne	%g11, %g12, jeq_else.1729
	addi	%g3, %g0, 5
	jmp	jeq_cont.1730
jeq_else.1729:
	addi	%g6, %g0, 2
	mvhi	%g11, 305
	mvlo	%g11, 11520
	jlt	%g11, %g12, jle_else.1731
	jne	%g11, %g12, jeq_else.1733
	addi	%g3, %g0, 2
	jmp	jeq_cont.1734
jeq_else.1733:
	addi	%g10, %g0, 1
...
jle_cont.1728:
	...
	mul	%g10, %g3, %g10
	sub	%g10, %g12, %g10
	jlt	%g0, %g3, jle_else.1755
	ld	%g11, %g1, 4
	jne	%g11, %g0, jeq_else.1757
	addi	%g3, %g0, 0
	jmp	jeq_cont.1758
jeq_else.1757:
	addi	%g11, %g0, 48
...
jle_cont.1756:
	...
	mvlo	%g12, 19264
	st	%g3, %g1, 8
	jlt	%g12, %g10, jle_else.1759
	jne	%g12, %g10, jeq_else.1761
	addi	%g3, %g0, 5
	jmp	jeq_cont.1762
jeq_else.1761:
	addi	%g6, %g0, 2
	mvhi	%g12, 30
	mvlo	%g12, 33920
	jlt	%g12, %g10, jle_else.1763
	jne	%g12, %g10, jeq_else.1765
	addi	%g3, %g0, 2
	jmp	jeq_cont.1766
jeq_else.1765:
	addi	%g11, %g0, 1
