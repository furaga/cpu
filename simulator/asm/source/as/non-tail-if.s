...
jle_else.1718:
	...
	mul	%g8, %g5, %g4
	sub	%g9, %g6, %g7
	jlt	%g28, %g9, jle_else.1723
	mov	%g3, %g7
	return
jle_else.1723:
	jlt	%g8, %g3, jle_else.1724
	jne	%g8, %g3, jeq_else.1725
	mov	%g3, %g5
	return
jeq_else.1725:
	mov	%g6, %g5
...
jle_else.1724:
	jmp	div_binary_search.336
print_int.341:
	jlt	%g3, %g0, jge_else.1726
	mvhi	%g10, 1525
	mvlo	%g10, 57600
	jlt	%g10, %g3, jle_else.1727
	jne	%g10, %g3, jeq_else.1729
	addi	%g10, %g0, 1
	jmp	jeq_cont.1730
jeq_else.1729:
	addi	%g10, %g0, 0
...
jle_cont.1738:
	...
	mul	%g10, %g3, %g10
	sub	%g10, %g12, %g10
	jlt	%g0, %g3, jle_else.1765
	ld	%g11, %g1, 4
	jne	%g11, %g0, jeq_else.1767
	addi	%g3, %g0, 0
	jmp	jeq_cont.1768
jeq_else.1767:
	addi	%g11, %g0, 48
...
jle_cont.1770:
	...
	mul	%g11, %g3, %g11
	sub	%g10, %g10, %g11
	jlt	%g0, %g3, jle_else.1797
	ld	%g11, %g1, 8
	jne	%g11, %g0, jeq_else.1799
	addi	%g3, %g0, 0
	jmp	jeq_cont.1800
jeq_else.1799:
	addi	%g11, %g0, 48
...
jle_cont.1802:
	...
	mul	%g11, %g3, %g11
	sub	%g10, %g10, %g11
	jlt	%g0, %g3, jle_else.1829
	ld	%g11, %g1, 12
	jne	%g11, %g0, jeq_else.1831
	addi	%g3, %g0, 0
	jmp	jeq_cont.1832
jeq_else.1831:
	addi	%g11, %g0, 48
...
min_caml_start:
	...
	call	min_caml_truncate
	addi	%g1, %g1, 8
	jlt	%g3, %g0, jge_else.1961
	mov	%g13, %g10
	jmp	jge_cont.1962
jge_else.1961:
	mov	%g13, %g11
jge_cont.1962:
	jlt	%g0, %g10, jle_else.1963
	mov	%g14, %g11
	jmp	jle_cont.1964
jle_else.1963:
	mov	%g14, %g3
