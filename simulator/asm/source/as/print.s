...
div_binary_search.334:
	...
	mul	%g9, %g4, %g7
	sub	%g3, %g6, %g5
	jlt	%g28, %g3, jle_else.683
	mov	%g3, %g5
	return
jle_else.683:
	jlt	%g9, %g8, jle_else.684
	jne	%g9, %g8, jeq_else.685
	mov	%g3, %g4
	return
jeq_else.685:
	mov	%g6, %g4
...
jle_cont.688:
	...
	ldi	%g8, %g1, 4
	sub	%g8, %g8, %g4
	jlt	%g0, %g3, jle_else.689
	jne	%g10, %g0, jeq_else.691
	addi	%g11, %g0, 0
	jmp	jeq_cont.692
jeq_else.691:
	addi	%g4, %g0, 48
...
jle_cont.694:
	...
	ldi	%g8, %g1, 12
	sub	%g8, %g8, %g4
	jlt	%g0, %g3, jle_else.697
	jne	%g10, %g0, jeq_else.699
	addi	%g11, %g0, 0
	jmp	jeq_cont.700
jeq_else.699:
	addi	%g4, %g0, 48
